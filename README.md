...
TAVILY_API_KEY=your_tavily_api_key_here # Optional fallback provider
NEWS_API_KEY=your_newsapi_key_here       # Optional fallback provider
```
...
![Data Provider Smart Router](./charts/data_layer.drawio.png)